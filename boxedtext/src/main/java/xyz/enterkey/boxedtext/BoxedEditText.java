...
public class BoxedEditText extends AppCompatAutoCompleteTextView {

    private static final String TAG = "BoxedEditText";
    ...
    public BoxedEditText(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.BoxedEditTextStyle);
    }
    ...
    public BoxedEditText(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = theme.obtainStyledAttributes(attrs, R.styleable.BoxedEditText, defStyleAttr, 0);


        mViewType = a.getInt(R.styleable.BoxedEditText_bt_viewType, VIEW_TYPE_RECTANGLE);

        mPinItemCount = a.getInt(R.styleable.BoxedEditText_bt_itemCount, DEFAULT_COUNT);
        mPinItemHeight = a.getDimensionPixelSize(R.styleable.BoxedEditText_bt_itemHeight,
                res.getDimensionPixelSize(R.dimen.box_text_item_size));
        mPinItemWidth = a.getDimensionPixelSize(R.styleable.BoxedEditText_bt_itemWidth,
                res.getDimensionPixelSize(R.dimen.box_text_item_spacing));
        mPinItemSpacing = a.getDimensionPixelSize(R.styleable.BoxedEditText_bt_itemSpacing,
                res.getDimensionPixelSize(R.dimen.box_text_item_spacing));
        mPinItemRadius = a.getDimensionPixelSize(R.styleable.BoxedEditText_bt_itemRadius, 0);
        mLineWidth = a.getDimensionPixelSize(R.styleable.BoxedEditText_bt_lineWidth,
                res.getDimensionPixelSize(R.dimen.box_text_item_line_width));
        mLineColor = a.getColorStateList(R.styleable.BoxedEditText_bt_lineColor);
        isCursorVisible = a.getBoolean(R.styleable.BoxedEditText_android_cursorVisible, true);
        mCursorColor = a.getColor(R.styleable.BoxedEditText_bt_cursorColor, getCurrentTextColor());
        mCursorWidth = a.getDimensionPixelSize(R.styleable.BoxedEditText_bt_cursorWidth,
                res.getDimensionPixelSize(R.dimen.box_text_cursor_width));
        a.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            if ( width1 == LayoutParams.MATCH_PARENT) {
                width = widthSize;
            }else if ( width1 == LayoutParams.WRAP_CONTENT){
